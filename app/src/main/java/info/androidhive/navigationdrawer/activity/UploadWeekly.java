...
public class UploadWeekly extends AppCompatActivity {
    ...
    private void getPdfs() {
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.PDF_FETCH_WEEK,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                Toast.makeText(UploadWeekly.this,jsonObject.getString("name"), Toast.LENGTH_SHORT).show();
                                pdf.setName(pdfName);
                                pdf.setUrl(pdfUrl);
                                pdfList.add(pdf);
                            ...
                            pdfAdapter=new PDFAdapter(UploadWeekly.this,R.layout.list_layout, pdfList);
