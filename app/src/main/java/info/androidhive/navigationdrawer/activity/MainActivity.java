...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String urlProfileImg = "http://icons.iconarchive.com/icons/mahm0udwally/all-flat/256/User-icon.png";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (navItemIndex == 3) {
            getMenuInflater().inflate(R.menu.blackmain, menu);
        }
